            ...
            class TestSQLite3Adapter < Minitest::Test
                ...
                def test_exec_query
                    ...
                    if RUBY_VERSION <= '2.5.0'
                        ...
                        # event verify
                        args1 = [{:sql=>"          SELECT name\n          FROM sqlite_master\n          WHERE (type = 'table' OR type = 'view') AND NOT name = 'sqlite_sequence'\n", :parameters=>[]}]
                        args2 = [{:sql=>"INSERT INTO \"fake_users\" (\"id\", \"email\", \"name\", \"ssn\") VALUES (?, ?, ?, ?)", :parameters=>["1", "me@john.com", "John", "11"]}]
                    ...
                    # event verify
                    if RUBY_VERSION <= '2.5.0'
                        args1 = [{:sql=>"SELECT \"fake_users\".* FROM \"fake_users\" WHERE \"fake_users\".\"id\" = ? LIMIT 1", :parameters=>["1"]}]
                    else
